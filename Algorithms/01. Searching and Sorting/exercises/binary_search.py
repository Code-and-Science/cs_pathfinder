...
def binary_search_iterative(lst):
    target = random.randint(0, len(lst) - 1)
...
def binary_search_recursive(lst):
    target = random.randint(0, len(lst) - 1)
...
if __name__ == "__main__":
    sizes = [10, 100, 1_000, 10_000, 100_000, 1_000_000, 10_000_000, 100_000_000, 1_000_000_000]
    ...
    run_performance_analysis(algorithms, sizes, generate_list_sequential, algorithm_names)
